...
// ******************************
//  зануление децимал
void s21_decimal_to_null(s21_decimal *value);
...
void s21_str_bin(char *binary_number, s21_decimal *value);
// формирование строки десятичного числа из строки двоичного числа для
// декомпозиции
void s21_str_dec_without_pow(char *binary_number, char *dec_number);
...
void s21_pow_to_str_dec(char *dec_number, char *dec_str, sign_and_pow scale);
//  изменение децималов под единую степень или ошибка если переполнение
void s21_add_multi_pow(s21_decimal *value_1, s21_decimal *value_2);
void s21_add_pow_to_mul(s21_decimal value_1, s21_decimal value_2,
                        s21_decimal *result);
int s21_get_last_dec_digit(s21_big_decimal value);
// установка флага переполнения на бесконечно большое или бесконечно малое
void s21_apply_flag_to_mauch_or_litle(int *flag, s21_big_decimal res);
// установка степени в биг децимал
void s21_apply_pow(s21_big_decimal *value, int32_t pow);
...
// положительных
void s21_math_add(s21_big_decimal val_1, s21_big_decimal val_2,
                  s21_big_decimal *res, sign_and_pow scale_1,
                  sign_and_pow scale_2, int *flag);
// сумма двух децималов - повторяется два раза, декомпозиция
int32_t s21_add_two_positiv(s21_decimal *result, s21_decimal value_1,
                            s21_decimal value_2);
// оценка переполнения
int s21_add_overflow(uint32_t x, uint32_t y);

// увеличиваем степень числа. для декомпозиции
void s21_pow_up(int32_t *change_pow, s21_decimal *value_1, s21_decimal *value_2,
                sign_and_pow scale_2);
// суммирование биг дицималов. декомпозиция
void s21_plus_plus_big(s21_big_decimal value_1, s21_big_decimal value_2,
...
void s21_add_zero_to_end_result(s21_decimal *result, int len_res);

// ****************************** s21_sub сопутствующие функции
// ****************************** декомпозиция набора функций по вычитанию двух
// чисел val2 БОЛЬШЕЕ
void s21_math_sub_small_big(s21_big_decimal *val_1, s21_big_decimal *val_2,
                            s21_big_decimal *res, sign_and_pow scale_1,
...
void s21_math_sub_big_small(s21_big_decimal *val_1, s21_big_decimal *val_2,
                            s21_big_decimal *res, sign_and_pow scale_1,
                            sign_and_pow scale_2, s21_decimal value_1,
                            s21_decimal value_2, int *flag);
// тоже но биг децимал
...
void s21_pow1_pow2_align(s21_big_decimal *val_1, s21_big_decimal *val_2,
...
int s21_div_zero_pow_big(s21_big_decimal value_1, s21_big_decimal value_2,
                         s21_big_decimal *res_temp);
// установка знака в резал декомпозиция
void s21_sign_for_res(sign_and_pow sc_1, sign_and_pow sc_2,
                      s21_big_decimal *res);
...
// // ******************************
void s21_print_bin(s21_decimal value);
void s21_print_hex(s21_decimal value);
void s21_print_dec(s21_decimal value);
// //  печать биг децимал
...
// ******************************
s21_decimal s21_left_shift(s21_decimal value, int n);
s21_decimal s21_right_shift(s21_decimal value, int n);
...
int s21_count_bits(s21_decimal value);

// ****************************** bit работа с конкретным бит
// ****************************** получить (get) и записать (set) бит
int s21_get_bit(s21_decimal value, uint8_t bit_idx);
int s21_set_bit(s21_decimal *value, uint8_t bit_idx, uint8_t bit_val);
...
s21_decimal s21_big_decimal_to_decimal(s21_big_decimal value);
// парсинг знака и разряда для точки
sign_and_pow s21_parsing_sign_and_pow_big(s21_big_decimal value);
...
void s21_str_bin_big(char *binary_number, s21_big_decimal *value);
// определеяет количество битов в биг десимал числе
int s21_count_bits_big(s21_big_decimal value);
// получить (get) и записать (set) бит для биг децимал
int s21_get_bit_big(s21_big_decimal value, uint8_t bit_idx);
int s21_set_bit_big(s21_big_decimal *value, uint8_t bit_idx, uint8_t bit_val);
//   сдвиг налево на n бит
s21_big_decimal s21_left_shift_big(s21_big_decimal value, int n);
s21_big_decimal s21_right_shift_big(s21_big_decimal value, int n);
...
void s21_sub_big_small_big(s21_big_decimal value_1, s21_big_decimal value_2,
                           s21_big_decimal *result);
void s21_big_decimal_to_null(s21_big_decimal *value);
// сложение двух биг децималов одинаковой степени
int32_t s21_add_two_positiv_big(s21_big_decimal *result,
...
int s21_mul_equal_pow_big(s21_big_decimal value_1, s21_big_decimal value_2,
                          s21_big_decimal *result);
// получить (get) и записать (set) степень (power) и знак (sign)
uint8_t s21_get_power_big(s21_big_decimal value);
int s21_set_power_big(s21_big_decimal *value, uint8_t power);
int s21_get_sign_big(s21_big_decimal value);
void s21_set_sign_big(s21_big_decimal *value, int sign);

// проверка на валидность s21_decimal для функции s21_from_decimal_to_int
int s21_validation_check(s21_decimal src);
int s21_validation_check_for_float(s21_decimal src);
int s21_count_bits(s21_decimal src);
s21_decimal s21_div_to_ten(s21_decimal src);
int s21_beginning(int arr[]);
int s21_first_5_bits(int arr[], int index);
int s21_finding_the_first_divisible(int first_num, int *index);
