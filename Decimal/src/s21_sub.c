  ...
  if (!s21_is_equal(value_1, value_2)) {
    ...
    if (!scale_1.sign && !scale_2.sign) {
      ...
      if (s21_is_greater_or_equal_big(val_2, val_1)) {
        ...
        s21_math_sub_small_big(&val_1, &val_2, &res, scale_1, scale_2, value_1,
                               value_2, &flag);
        ...
        *result = s21_big_decimal_to_decimal(res);
        ...
        s21_math_sub_big_small(&val_1, &val_2, &res, scale_1, scale_2, value_1,
                               value_2, &flag);
      ...
      // IV. (-1) - (-2)
      s21_set_sign_big(&val_1, 0);
      s21_set_sign_big(&val_2, 0);
...
void s21_pow1_pow2_align(s21_big_decimal *val_1, s21_big_decimal *val_2,
  ...
  if (s21_get_power(value_1) > s21_get_power(value_2)) {
    s21_apply_pow(val_2, s21_get_power(value_1));
  } else {
    s21_apply_pow(val_1, s21_get_power(value_2));
  }

  // установили степень в ноль
  s21_set_power_big(val_1, 0);
  s21_set_power_big(val_2, 0);
}
